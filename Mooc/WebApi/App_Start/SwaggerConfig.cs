...
namespace WebApi
{
    public class SwaggerConfig
    {
        ...
        {
            /// <summary>  
            /// overwrite Apply method,remove hide interface generation
            /// </summary>  
            /// <param name="swaggerDoc">swagger doc</param>  
            /// <param name="schemaRegistry"></param>  
            /// <param name="apiExplorer">api interface collection</param>  
        ...
        public class GlobalHttpHeaderFilter : IOperationFilter
        {
            public void Apply(Operation operation, SchemaRegistry schemaRegistry, ApiDescription apiDescription)
            {
                ...
                {
                    operation.parameters.Add(new Parameter { name = "jwt", @in = "header", description = "jwt", required = true, type = "string" });
                }
            }
